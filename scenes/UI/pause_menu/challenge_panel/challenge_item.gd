...
const ITEM_CHECK_STYLE = preload("res://scenes/UI/pause_menu/challenge_panel/item_check_style.tres")
const ITEM_UNCHECK_STYLE = preload("res://scenes/UI/pause_menu/challenge_panel/item_uncheck_style.tres")
